...
@Component({
  selector: 'home-health',
  templateUrl: './home-health.component.html',
  styleUrls: ['./home-health.component.css']
})
export class HomeHealth extends Tabbing implements  OnDestroy  {

  homehealthBuffer:any=[];
  ...
  constructor(private httpService : HttpService ,public router:Router,public storeInfoService:StoreInfoService,private renderer: Renderer2) {
    ...
    this.homehealthBuffer=(this.storeInfoService.getHomeHealth().length==0)?[]:this.storeInfoService.getHomeHealth();

  }
  ngOnDestroy()
  {
    this.storeInfoService.setHomeHealth(this.homehealthBuffer);
  }
